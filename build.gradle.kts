...
tasks {
    shadowJar {
        ...
        relocate("dev.jorel.commandapi", "cn.encmys.ykdz.forest.landsqqbot.libraries.commandapi")
        relocate("org.bstats", "cn.encmys.ykdz.forest.landsqqbot.libraries.bstats")
        relocate("net.kyori", "cn.encmys.ykdz.forest.landsqqbot.libraries")
    }
}